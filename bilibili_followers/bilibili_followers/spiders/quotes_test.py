...
class FollowerSpider(scrapy.Spider):
    name = 'followers'
    start_urls = [
        'https://www.bilibili.com/v/music/other/'
    ]
    headers = {
        "accept": "*/*",
        ...
        "referer": "https://www.bilibili.com/v/music/other/",
    ...
    def parse(self, response):
        callback = 'jqueryCallback_bili_35071251941392223'
        # page = 1
        pagesize = '20'
        time_from = '20200301'
        time_to = '20200331'
        cate_id = '28'  # different tag chanel id, music_others(130),  music_original(28)

        # from page 1 to 100, 20 items per page
        for i in range(100):
